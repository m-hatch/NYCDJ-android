...
public class Artist2 extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent tourIntent = new Intent(this, A2_tab2.class);
