...
public class Artist1 extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent tourIntent = new Intent(this, A1_tab2.class);
