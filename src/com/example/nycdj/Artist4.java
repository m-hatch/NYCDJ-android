...
public class Artist4 extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent tourIntent = new Intent(this, A4_tab2.class);
